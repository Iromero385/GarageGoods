      ...
      <Row >
        <Col md={12} xs={10} className="aboutUsBackground" >
          ...
          <div>
            ...
            About GarageGoods
We collect, review and deliver the best information --- so you don’t have too.
...
At GarageGoods , we collect, review, and deliver the best information in the market, so you don’t have to. Our data collects the presents and future garage sales and can be search by categories, city and zip code. You can also create, check your post and review your incoming garage sales.  
